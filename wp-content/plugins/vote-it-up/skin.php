...
?>
<!--<div style="float:left; padding: 5px">-->
<input type="radio" name="voteiu_skin" id="voteiu_skin" value="<?php echo $skins[$i]; ?>" <?php IsChecked($skins[$i]); ?> /> <?php echo ucfirst(str_replace('_', ' ', $skins[$i])); ?><br>
<!--</div>-->
<?php
}
}
...
/* Useful functions used in skins */
